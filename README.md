...
[![](https://img.shields.io/badge/docs-godoc-blue.svg)](https://godoc.org/github.com/hi-solutions/go-webpbin)
...
```go get -u github.com/hi-solutions/go-webpbin```
...
import (
	...
	"log"
	"os"
	"github.com/hi-solutions/go-webpbin"
)
